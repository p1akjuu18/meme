...
if __name__ == "__main__":
    ...
    INPUT_PATH = os.path.join(desktop_path, 'masonaddress.xlsx')
    OUTPUT_PATH = os.path.join(desktop_path, 'masonaddress_processed.xlsx')
    ...
    # 合并所有sheet的地址
    MERGED_OUTPUT_PATH = os.path.join(desktop_path, 'masonaddress_merged.xlsx')
